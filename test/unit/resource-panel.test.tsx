...
const snapshot: OfficeRuntimeResourceSnapshot = {
  ...
  operation: null,
  error: null,
  installedRelease: 'v0.4.3-test',
  targetRelease: 'v0.4.3-test',
  availableRelease: 'v0.4.3-test',
...
describe('OfficeResourcePanel', () => {
  it.each(['zh-CN', 'en-US'] as const)(
    ...
    async (locale) => {
      ...
      expect(host.textContent).toContain('OnlyOffice 0.4.3');
