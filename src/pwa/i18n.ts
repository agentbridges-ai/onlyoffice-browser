...
export const officeCopy: Record<OfficeLocale, OfficeCopy> = {
  ...
  'en-US': {
    ...
    resourcesNeeded: 'Resources required',
    ...
    resourceIntro:
      'The editor opens only after the complete package is downloaded and verified. All 12 editor origins share one set of components, conversion runtime, and fonts.',
